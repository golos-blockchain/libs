...
ChainTypes.operations = {
  ...
  fill_convert_request: 81,
  author_reward: 82,
  curation_reward: 83,
  comment_reward: 84,
  liquidity_reward: 85,
  interest: 86,
  fill_vesting_withdraw: 87,
  fill_order: 88,
  shutdown_witness: 89,
  fill_transfer_from_savings: 90,
  hardfork: 91,
  comment_payout_update: 92,
  comment_benefactor_reward: 93,
  return_vesting_delegation: 94,
  producer_reward: 95,
  delegation_reward: 96,
  auction_window_reward: 97,
};
