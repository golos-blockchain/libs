...
ChainTypes.operations = {
  ...
  fill_convert_request: 74,
  author_reward: 75,
  curation_reward: 76,
  comment_reward: 77,
  liquidity_reward: 78,
  interest: 79,
  fill_vesting_withdraw: 80,
  fill_order: 81,
  shutdown_witness: 82,
  fill_transfer_from_savings: 83,
  hardfork: 84,
  comment_payout_update: 85,
  comment_benefactor_reward: 86,
  return_vesting_delegation: 87,
  producer_reward: 88,
  delegation_reward: 89,
  auction_window_reward: 90,
};
