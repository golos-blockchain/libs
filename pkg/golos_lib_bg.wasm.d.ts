...
export function _asset_new(a: number, b: number, c: number, d: number, e: number): number;
export function _asset_amount(a: number, b: number): void;
export function _asset_set_amount(a: number, b: number, c: number): void;
...
export function _asset__plus_num(a: number, b: number, c: number): number;
export function _asset__plus(a: number, b: number): number;
export function _asset__minus_num(a: number, b: number, c: number): number;
export function _asset__minus(a: number, b: number): number;
export function _asset__mul_num(a: number, b: number, c: number): number;
export function _asset__mul(a: number, b: number): number;
export function _asset__div_num(a: number, b: number, c: number): number;
...
export function multiply_buffers(a: number, b: number, c: number, d: number, e: number): void;
export const __wbindgen_export_0: WebAssembly.Table;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbcef8e440c0e4d5b(a: number, b: number, c: number): void;
